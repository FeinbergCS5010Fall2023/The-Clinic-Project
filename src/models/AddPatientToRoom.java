...
public class AddPatientToRoom extends JFrame {
	...
	private void movePatient() {
		...
		if (patient == null) {
			JOptionPane.showMessageDialog(AddPatientToRoom.this, "Patient doesn't exist. Please try again.", "Error",
		...
		if(room.getStatus() == true) {
			JOptionPane.showMessageDialog(
					AddPatientToRoom.this,
	                room.getRoomName() + " is full.",
	                "Room Assignment unSuccessful",
			...
			JOptionPane.showMessageDialog(
					AddPatientToRoom.this,
	                room.getRoomName() + " now has " + patient.getFirstName() 
	                + " " + patient.getLastName(),
	                "Room Assignment unSuccessful",
	                JOptionPane.INFORMATION_MESSAGE);
